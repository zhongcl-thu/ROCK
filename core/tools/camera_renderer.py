...
from tools.bop_toolkit_lib import view_sampler
from tools import io_interface
...
class ModelRenderer:
    def __init__(self, camera_info, view_radius):
        ...
        self.sift = cv2.xfeatures2d_SIFT.create() #cv2.SIFT_create()
...
def render_models(model_renderer, images_path, models_path, models, over_write, suffix=''):
    ...
    for model_id, model in enumerate(models):
        ...
        model_path = os.path.join(models_path, model, 'textured.obj')
